...
public class Utils
{
    ...
    private static final IWorldPool m_iWorldPool = new DefaultWorldPool(WORLD_POOL_SIZE, WORLD_POOL_CONTAINER_SIZE);
    public static final World world = new World(new Vec2(0.0f, 10.0f), m_iWorldPool);
    ...
    public static void addGround(float width, float height)
    {
        ...
        bd.position = new Vec2(0.0f, 120f);
